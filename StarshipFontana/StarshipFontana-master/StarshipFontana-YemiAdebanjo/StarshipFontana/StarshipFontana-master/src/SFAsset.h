 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_ASTEROID, SFASSET_BOTTOMWALL, SFASSET_TOPWALL, SFASSET_LEFTWALL, SFASSET_RIGHTWALL, SFASSET_BACKGROUND, SFASSET_MOTHERSHIP, SFASSET_GAMEOVER};
...
public:
  ...
  virtual void      NorthWallCollision();
  virtual void      WestWallCollision();
  virtual void      EastWallCollision();
  virtual void      PlayerBulletNorth();
  virtual void      AlienBulletSouth();
